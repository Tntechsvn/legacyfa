    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="header-table-style2">
            ...
            <div class="action-table-style">
                <a class="pull-right link-trash iconlinktrash radius_4" href="{{route('rider.list_trash')}}" data-title="List Trash"><i class="lni lni-trash"></i></a>
                <div class="search-table search-fn">
                    <form class="radius_4" method="get" action="{{route('pfr.list')}}">
                        ...
                        <i class="lni lni-search-alt radius_2" data-title="Search"></i>
                    </form>
                </div>
                <button type="button" class="btn btn-primary add_new radius_4" data-toggle="modal" data-target="#modal_add_new" data-title="Add New"><i class="lni lni-plus"></i></button> 
            </div>
        </div>
