    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="header-table-style2">
            ...
            <div class="action-table-style">
                <a class="pull-right link-trash iconlinktrash radius_4" href="{{route('company.list_trash')}}"><i class="lni lni-trash"></i></a>
                ...
                <button type="button" class="btn btn-primary add_new radius_4" id="add_company" data-toggle="modal" data-target="#modal_add_new"><i class="lni lni-plus"></i></button>
            </div>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:;"  class="deletestyle1 delete" data-url="{{route('company.move_to_trash', $company->id)}}" data-title="Delete"><i class="lni lni-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
