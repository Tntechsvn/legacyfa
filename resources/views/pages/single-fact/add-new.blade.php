...
<div class="maincontent">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form name="addsinglefact_form" id='addsinglefact_form' class="form-control" method="post" action="" data-parsley-validate>
...
<!--                 <select class="form-control selectpicker countrypicker" name="select-country" id="select-country" ></select> -->
                <select name="nationality" id="select-nationality"  name="select-nationality">
