    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="header-table-style2">
            <div class="action-table-style">
                <a class="pull-right link-trash iconlinktrash radius_4" href="{{route('singlefact.dependant.list_trash', $infoPfr->id)}}"><i class="lni lni-trash"></i></a>
                ...
                <button type="button" class="btn btn-primary add_new radius_4" id="add_dependants" data-url="{{route('singlefact.dependant.add_new', $infoPfr->id)}}"><i class="lni lni-plus"></i></button>
            </div>
        </div>
