    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="form_property" id='form_property' class="form-control" method="post" action="" data-parsley-validate>
                    @csrf
...
<div class="modal fade" id="investment-modal" tabindex="-1" role="dialog" aria-labelledby="property-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="form_investment" id='form_investment' class="form-control" method="post" action="" data-parsley-validate>
                    @csrf
                    <div class="form-group">
