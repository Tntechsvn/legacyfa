            ...
            <table id="protection3-2" class="table table-content table-style1 protection-st protection-st2" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" class="form-control" id="annual_amount_dependent5" name="annual_amount_dependent4" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
                        <td>Number of Years Needed</td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control" id="capital_sum_dependent3" name="capital_sum_dependent3" placeholder="$" value="" ></td>
                        <td><input type="number" class="form-control" id="capital_sum_dependent4" name="capital_sum_dependent4" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
                        <td>Medical Expenses ($)</td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control" id="mortgage_dependent1" name="mortgage_dependent4" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
                        <td>Loans/Others ($)</td>
                        <td><input type="number" class="form-control" id="loan_others_dependent2" name="loan_others_dependent2" placeholder="$" value="" ></td>
                        <td><input type="number" class="form-control" id="loan_others_dependent3" name="loan-others_dependent3" placeholder="$" value="" ></td>
