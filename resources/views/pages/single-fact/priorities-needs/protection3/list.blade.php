            ...
            <table id="protection3-2" class="table table-content table-style1 protection-st protection-st2" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" class="form-control" id="annual-amount-dependent5" name="annual-amount-dependent4" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
                        <td>Number of Years Needed</td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control" id="mortgage-dependent1" name="mortgage-dependent4" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
                        <td>Loans/Others ($)</td>
                    ...
                    <tr>
                        <td>B. TOTAL CASH OUTFLOW ($)</td>
                        <td><input type="number" class="form-control" id="total-cash-dependent2" name="total-cash-dependent2" placeholder="$" value="" readonly></td>
