            ...
            <table id="blance-table" class="table table-content table-style1" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control" id="personal-debts-client1" name="personal-debts-client1" placeholder="$" value="" ></td>
                        <td><input type="number" class="form-control" id="personal-debts-dependent1" name="personal-debts-dependent1" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
                        <td>Others ($)</td>
                        <td><input type="number" class="form-control" id="others-client1" name="others-client1" placeholder="$" value="" ></td>
                        <td><input type="number" class="form-control" id="others-dependent1" name="others-dependent1" placeholder="$" value="" ></td>
                    </tr>
                    <tr>
