...
<!-- modal list pfr  -->
<div class="modal fade" id="pfr-modal" tabindex="-1" role="dialog" aria-labelledby="pfr-modal" aria-hidden="true">
            ...
            <div class="modal-body">
                <form name="form_add_new" id='form_add_new' class="form-control-popup" method="post" action="{{route('user.add_new')}}" data-parsley-validate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="single_name" name="single_name" placeholder="Name" value="" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="passport_no" name="passport_no" placeholder="NRIC/Passport No" value="" >
                    </div>
                    <div class="form-group">
                        <label for="select-country">Nationality<span>*</span></label>
                        <select id="select_nationality" name="select_nationality">
                    ...
                    <div class="form-group">
                        ...
                        <select name="select_residency" id="select_residency" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select name="select_marital" id="select_marital" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select name="select_employment" id="select_employment" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" value="" required>
                    </div>
                    <div class="form-group">
                        <label for="business_nature">Business Nature<span>*</span></label>
                        <input type="text" class="form-control" id="business_nature" name="business_nature" placeholder="Business Nature" value="" required>
                    </div>
                    <div class="form-group">
                        <label for="select_annual_income">Annual Income Range ($)<span>*</span></label>
                        <select name="select_annual_income" id="select_annual_income" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="details_mobile" name="details_mobile" placeholder="Contact Details" value="" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="residential_address" name="residential_address" placeholder="Residential Address" value="" required>
                    </div>
                    <div class="form-group">
                        <label for="mailing_address">Mailing Address</label>
                        <input type="tel" class="form-control" id="mailing_address" name="mailing_address" placeholder="Mailing Address" value="">
